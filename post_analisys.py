...
N, bins, patches = plt.hist(slides[:, 0], histtype=u'step', label='full')
plt.hist(inf, bins=bins, histtype=u'step', label='lateral < 2')
plt.hist(sup, bins=bins, histtype=u'step', label='lateral > 2')
plt.legend()
plt.show()
...
#plt.show()
plt.title('lateral')
N, bins, patches = plt.hist(slides[:, 1], histtype=u'step', label='full')
plt.hist(inf, bins=bins, histtype=u'step', label='lateral < 2')
plt.hist(sup, bins=bins, histtype=u'step', label='longitudinal < 4')
plt.legend()
plt.show()
...
plt.title('Distance')
plt.hist(distance, normed=1, bins=20)
plt.show()
